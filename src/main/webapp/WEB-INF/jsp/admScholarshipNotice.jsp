    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="active"><a  href="/scholarship/admScholarshipNotice">奖学金公示</a></li>
            </ul>
...
<div class="container" style="margin-top:50px;margin-bottom:50px">
    <div class="row" id="scholarshipShow">
                ...
                <div class="well" style="background-color:white;">
                    <table frame="void">
                        ...
                        <tr style="height:35px">
                            <td><button type="button" class="btn btn-default" onclick="showPublicity('${scholarship.scholarship_id}')">公示记录</button></td>
                            <td><button type="button" class="btn btn-primary" onclick="getPassApply('${scholarship.scholarship_id}')">公示名单</button></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <c:forEach var="scholarship" items="${scholarshipList}">
            <div class="collapse col-sm-6 sol-md-7 col-lg-8 col-xs-10" id="${scholarship.scholarship_id}publicity" style="min-width:400px">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: black">
                        <h3 class="panel-title" style="color: #9d9d9d;">${scholarship.scholarship_name}公示记录</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped" style="text-align:center">
                            ...
                            <tbody id="${scholarship.scholarship_id}publicityList">
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="collapse col-sm-12 sol-md-12 col-lg-12 col-xs-12" id="${scholarship.scholarship_id}" style="min-width:1000px">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <label class="control-label" for="start_time">设置时间</label>
                        <input class="easyui-datetimebox" type="text" id="start_time" name="start_time">
                        <label class="control-label" for="end_time">至</label>
                        <input class="easyui-datetimebox" type="text" id="end_time" name="end_time">
                        <button type="button" class="btn btn-primary" onclick="publicityScholarship('${scholarship.scholarship_id}')">公示</button>
                        <button type="button" class="btn btn-primary" onclick="exportScholarship('${scholarship.scholarship_id}')">导出</button>
                    </div>
                </div>
            </div>
        </c:forEach>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table frame="void" style="width:400px;margin:0 auto">
                    ...
                    <tr style="height:35px">
                        <th>开始时间</th>
                        <td><h5 id="start_time1"></h5></td>
                    </tr>
                    <tr style="height:35px">
                        <th>结束时间</th>
                        <td><h5 id="end_time1"></h5></td>
                    </tr>
                    <tr style="height:35px">
                        <th>设立单位</th>
...
<script src="<%=request.getContextPath()%>/resources/js/admScholarshipNotice.js"></script>
</html>
