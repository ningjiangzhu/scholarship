    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="active"><a  href="/scholarship/stuScholarshipCheck">奖学金审核</a></li>
...
<div class="container" style="margin-top:50px;margin-bottom:50px">
    <div class="row">
        <c:forEach var="apply" items="${applyList}" varStatus="v">
            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-7" id="${apply.apply_id}">
                <div class="well" style="background-color:white;">
                    <table frame="void">
                        ...
                        <tr style="height:30px">
                            <td>申请时间</td>
                            <td><fmt:formatDate value="${apply.apply_time}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                        </tr>
                        <tr style="height:30px">
                            <td>申请状态</td>
                        ...
                        <tr style="height:30px">
                            <td>审核时间</td>
                            <td><fmt:formatDate value="${apply.check_time}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                        </tr>
                        <tr style="height:35px">
                            <td><button type="button" class="btn btn-default" onclick="showApply('${apply.apply_id}')">详情</button></td>
                            <td><button type="button" class="btn btn-danger" onclick="deleteApply('${apply.apply_id}')">取消申请</button></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table frame="void" style="width:400px;margin:0 auto">
                    ...
                    <tr style="height:35px">
                        ...
                        <td style="width: 300px"><h5 id="apply_time"></h5></td>
                    </tr>
                    <tr style="height:35px">
                        <th>申请状态</th>
                        <td><h5 id="apply_state"></h5></td>
                    </tr>
                    <tr style="height:35px">
                        <th>审核时间</th>
                        <td><h5 id="check_time"></h5></td>
                    </tr>
                    <tr style="height:40px">
                        <th>申请理由</th>
                        <td><h5 style="white-space:pre-wrap;width:300px;max-height: 100px;overflow: auto" id="apply_reason"></h5></td>
                    </tr>
                    <tr style="height:40px">
                        <th>反馈信息</th>
                        <td><h5 style="white-space:pre-wrap;width:300px;max-height: 100px;overflow: auto" id="fail_reason"></h5></td>
                    </tr>
                    <tr style="height:40px">
                        <th>申请审批表</th>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="showApplyButton">取消申请</button>
...
<script src="<%=request.getContextPath()%>/resources/js/stuScholarshipCheck.js"></script>
</html>
